...
function getQuestions(){
    if(quantity!=null && selectedcategory!=null && selecectedDifficulty!=null && quantity < 50){
        ...
        .then(function(){
            ...
            shufflequestions = [...questions[k]["incorrect_answers"],questions[k]["correct_answer"]].sort(() => Math.random() - 0.5);
            document.querySelector("user-card").shadowRoot.querySelector("#question").innerHTML=questions[k].question;
            ...
            document.querySelector("user-card").shadowRoot.querySelector("#quetion-count").innerHTML =k + 1  +"/" + questions.length;
...
function checkanswer(answer){
    ...
    if(answer===questions[k]["correct_answer"]){
            i++;
    }
    newQuestion();
